    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">แก้ไขข้อมูลทรัพย์สิน: {{ $asset->asset_id }}</h3>
            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="asset_id" id="asset_id" class="form-control @error('asset_id') is-invalid @enderror" 
                                       value="{{ old('asset_id', $asset->asset_id) }}" required>
                                @error('asset_id')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="status_id" id="status_id" class="form-control @error('status_id') is-invalid @enderror" required>
                                    ...
                                    <option value="{{ $status->id }}" {{ old('status_id', $asset->status_id) == $status->id ? 'selected' : '' }}>{{ $status->name }}</option>
                                    @endforeach
                                </select>
                                @error('status_id')
                                <span class="invalid-feedback">{{ $message }}</span>
